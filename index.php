	...
	<script type='text/javascript'>
		...
		function ClientList(clients) {
			...
			for (counter = 0; counter < clients.length; ++counter) {							
                ClientList.innerHTML += (counter + 1) + '.';
                ClientList.innerHTML += ' ' + clients[counter] + ': <u><a href="showlog.php?log=' + clients[counter] + '">View Log</a></u>';
                ClientList.innerHTML += ' <u><a href="stopclient.php?log=' + clients[counter] + '">Stop it</a></u><br>';
			}

			if (ClientList.innerHTML.length == 0) {
				ClientList.innerHTML += '<span class="omgerr">There are currently no connected clients</span>';
			}
		}
	</script>
</body>
